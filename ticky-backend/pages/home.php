<?php
$nap_nevek = ticky_day_names();
$nap = mai_nap();
$ido = aktualis_ido();
?>
<!DOCTYPE html>
<html lang="hu">
<?php render_app_head('Ticky'); ?>
<style>
    ...
    <div class="w-full max-w-md">
      <div class="fade-up text-center mb-10">
        ...
        <div class="flex items-center justify-center gap-2 mt-4">
          ...
          <span class="text-xs font-medium" style="color:#4ade80;"><?= htmlspecialchars($nap_nevek[$nap] ?? '', ENT_QUOTES, 'UTF-8') ?> · <?= htmlspecialchars($ido, ENT_QUOTES, 'UTF-8') ?> · Aktív</span>
        </div>
      </div>
