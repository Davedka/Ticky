...
<style>
  ...
  *, *::before, *::after { box-sizing:border-box; margin:0; padding:0; }
  ...
  .rooms-grid { scroll-behavior:smooth; -webkit-overflow-scrolling:touch; }
...
<!-- Status bar -->
<div id="szunet-kijelzo-banner" style="display:none;position:relative;z-index:50;padding:8px 28px;background:rgba(200,151,42,.15);border-bottom:1px solid rgba(200,151,42,.3);color:#f0c76b;font-size:13px;font-weight:600;align-items:center;gap:8px;"></div>
<div class="statusbar">
...
async function fetchRooms() {
  ...
  try {
    ...
    const szBanner = document.getElementById('szunet-kijelzo-banner')
    if(d.szunet && szBanner){ szBanner.style.display='flex'; szBanner.textContent='🌙 '+d.szunet+' – Szünet idején minden terem szabad' }
    else if(szBanner){ szBanner.style.display='none' }
    renderGrid()
