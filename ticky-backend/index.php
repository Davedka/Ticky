...
<style>
  *,*::before,*::after{box-sizing:border-box;}
  ...
  .hero{text-align:center;margin-bottom:40px;}.hero-cim{position:relative;display:inline-flex;align-items:center;justify-content:center;min-height:clamp(99px,25.9vw,146px);}.hero-cim .tm{position:absolute;right:100%;top:50%;transform:translateY(-50%);margin-right:clamp(6px,2vw,18px);}
  ...
  @media(max-width:340px){.hero-cim .tm{margin-right:0;}}
