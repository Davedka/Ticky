...
<style>
  ...
  .fade-up-2 { animation:fadeUp .5s .15s cubic-bezier(.22,1,.36,1) both; }
  .fade-up-3 { animation:fadeUp .5s .28s cubic-bezier(.22,1,.36,1) both; }
