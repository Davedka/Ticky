...
<style>
  *,*::before,*::after{box-sizing:border-box;}
  ...
  .navbar{
    ...
    background:rgba(6,15,30,.85);backdrop-filter:blur(20px);
  ...
  /* ── SIDEBAR ── */
  .ticky-sidebar{
    position:fixed;left:0;top:50%;transform:translateY(-50%);z-index:150;
  ...
  .card-big{
    ...
    padding:20px 22px;border-radius:0 0 14px 14px;border-top:none;
  }
